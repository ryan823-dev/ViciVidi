...
// ==================== MongoDB Enum Types (not generated by Prisma) ====================

export type ChannelType = 'TENDER' | 'MAPS' | 'DIRECTORY' | 'TRADESHOW' | 'HIRING' | 'ECOSYSTEM' | 'CUSTOM';
export type CandidateStatus = 'NEW' | 'REVIEWING' | 'QUALIFIED' | 'IMPORTED' | 'EXCLUDED' | 'EXPIRED' | 'ENRICHING';
export type CandidateType = 'COMPANY' | 'OPPORTUNITY' | 'CONTACT';
